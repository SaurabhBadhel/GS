...
public class DprAdapter extends RecyclerView.Adapter<MyViewHolder>{

    DprFragment dprFragment;
    ArrayList<Dpr> downModels;

    public DprAdapter(DprFragment dprFragment, ArrayList<Dpr> downModels) {
        this.dprFragment = dprFragment;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        LayoutInflater layoutInflater = LayoutInflater.from(dprFragment.getContext());
